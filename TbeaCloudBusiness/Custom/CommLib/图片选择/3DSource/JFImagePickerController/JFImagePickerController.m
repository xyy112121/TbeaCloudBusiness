...
- (void)viewDidLoad
{
	...
	toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT-44-IPhone_SafeBottomMargin, [UIScreen mainScreen].bounds.size.width, 44)];
    toolbar.tintColor = COLORNOW(0, 170, 238);//[UIColor whiteColor];

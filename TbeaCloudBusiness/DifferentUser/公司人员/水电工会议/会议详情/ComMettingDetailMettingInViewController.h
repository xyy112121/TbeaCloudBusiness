//
//  ComMettingDetailMettingInViewController.h
//  TbeaCloudBusiness
//
...
@interface ComMettingDetailMettingInViewController : UIViewController<YBPopupMenuDelegate,ActionDelegate,UITableViewDelegate,UITableViewDataSource>
{

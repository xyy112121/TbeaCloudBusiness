//
//  ComMettingDetailNewViewController.m
//  TbeaCloudBusiness
//
...
@interface ComMettingDetailNewViewController ()

@end

@implementation ComMettingDetailNewViewController
...
{
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[@"meetingid"] = [[FCdicdata objectForKey:@"meetingbaseinfo"] objectForKey:@"id"];
    
    
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:ReComWaterMettingDeleteMettingCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{

//
//  TbeaDetectUserYiJieDanViewController.m
//  TbeaCloudBusiness
//
...
#import "TbeaDetectUserYiJieDanViewController.h"

@interface TbeaDetectUserYiJieDanViewController ()

@end

@implementation TbeaDetectUserYiJieDanViewController
...
#pragma mark 接口
//获取详情
-(void)getyijiedandetailinfo
{
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[@"electricalcheckid"] = self.FCelectricalcheckid;
    
    
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQTbeaDetectUserYiJieDanInfoCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{

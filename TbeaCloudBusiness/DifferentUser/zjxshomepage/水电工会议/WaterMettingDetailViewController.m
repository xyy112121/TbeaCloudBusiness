//
//  WaterMettingDetailViewController.m
//  TbeaCloudBusiness
//
...
#import "WaterMettingDetailViewController.h"

@interface WaterMettingDetailViewController ()

@end

@implementation WaterMettingDetailViewController
...
{
    if([FCmettingstatus isEqualToString:@"新会议"])
    {
        return 3;
    }
    return 4;
    ...
    else if(indexPath.section == 2)
    {
        switch (indexPath.row)
        {
            ...
            case 2:
                ...
                labelvalue.text = FCmettingpicturenum;
                labelvalue.textAlignment = NSTextAlignmentRight;
                labelvalue.frame = CGRectMake(SCREEN_WIDTH-30-XYViewWidth(labelvalue), XYViewTop(labelvalue), XYViewWidth(labelvalue), XYViewHeight(labelvalue));
                [cell.contentView addSubview:labelvalue];
                break;

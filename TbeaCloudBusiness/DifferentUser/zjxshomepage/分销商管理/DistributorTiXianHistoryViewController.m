//
//  DistributorTiXianHistoryViewController.m
//  TbeaCloudBusiness
//
...
#import "DistributorTiXianHistoryViewController.h"

@interface DistributorTiXianHistoryViewController ()

@end

@implementation DistributorTiXianHistoryViewController
...
-(void)jingxiaoshangheader:(UIView *)viewheader
{
    ...
    NSString *strname = [FCdicpayeeinfo objectForKey:@"mastername"];
    ...
    NSString *stricon = [FCdicpayeeinfo objectForKey:@"persontypeicon"];
    ...
    NSString *strmoney = [NSString stringWithFormat:@"%@",[FCdicpayeeinfo objectForKey:@"totletakemoney"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *lablemoneyvalue = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-size2.width-20, 10, size2.width, 20)];
    lablemoneyvalue.text =strmoney;
    lablemoneyvalue.font = FONTMEDIUM(17.0f);
    lablemoneyvalue.textColor = [UIColor blackColor];
    lablemoneyvalue.textAlignment = NSTextAlignmentRight;
...
-(void)gettixianhistorylist:(NSString *)page Pagesize:(NSString *)pagesize
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQStoreDistributorTiXianHistoryCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
        ...
        if([[dic objectForKey:@"success"] isEqualToString:@"true"])
        {
            ...
            FCdicpayeeinfo = [[dic objectForKey:@"data"] objectForKey:@"distributorinfo"];

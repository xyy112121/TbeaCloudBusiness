//
//  TbeaBuySomeProductViewController.m
//  TbeaCloudBusiness
//
...
#import "TbeaBuySomeProductViewController.h"

@interface TbeaBuySomeProductViewController ()

@end

@implementation TbeaBuySomeProductViewController
...
-(void)getproductlist:(NSString *)page PageSize:(NSString *)pagesize
{
    ...
    params[@"vouchercode"] = _FCvouchercode;
    params[@"page"] = page;
    params[@"pagesize"] = pagesize;
    
    
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQTbeaBuyProductListCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{

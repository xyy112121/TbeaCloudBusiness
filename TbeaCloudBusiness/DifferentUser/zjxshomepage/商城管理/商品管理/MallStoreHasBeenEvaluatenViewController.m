//
//  MallStoreHasBeenEvaluatenViewController.m
//  TbeaCloudBusiness
//
...
#import "MallStoreHasBeenEvaluatenViewController.h"

@interface MallStoreHasBeenEvaluatenViewController ()

@end

@implementation MallStoreHasBeenEvaluatenViewController
...
{
    [self getgoodshasbeenevaluatedetail];
...
{
    float widthnow = (SCREEN_WIDTH-30)/3;
    UIView *view = [[UIView alloc] initWithFrame:frame];
    ...
    UILabel *lableevaluate = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-30-widthnow*2+20, XYViewTop(labeltitle), widthnow*2-20, 20)];
    lableevaluate.text = [sender objectForKey:@"evaluatecontent"];
    lableevaluate.font = FONTMEDIUM(15.0f);
    lableevaluate.textColor = COLORNOW(72, 72, 72);
    //    lableevaluate.textAlignment = NSTextAlignmentCenter;
    lableevaluate.backgroundColor = [UIColor clearColor];
    [view addSubview:lableevaluate];
    
    UILabel *labeltime = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-30-widthnow*2+20,XYViewTop(imageicon),widthnow*2-20,20)];
    labeltime.backgroundColor = [UIColor clearColor];
    labeltime.textColor = COLORNOW(117, 117, 117);
    labeltime.font = FONTN(14.0f);
    //    labeltime.textAlignment = NSTextAlignmentRight;
    labeltime.text = [sender objectForKey:@"evaluatetime"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    ButtonItemLayoutView *buttonitemuser = [[ButtonItemLayoutView alloc] initWithFrame:CGRectMake(10, 10, widthnow, 40)];
    ...
    ButtonItemLayoutView *buttonitemmoney = [[ButtonItemLayoutView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-30-widthnow*2, 10, widthnow*2, 40)];
    ...
    [buttonitemmoney updatebuttonitem:EnButtonTextCenter TextStr:@"评价时间" Font:FONTN(14.0f) Color:COLORNOW(117, 117, 117) Image:LOADIMAGE(@"arrawgray", @"png")];
...
#pragma mark 接口
-(void)getgoodshasbeenevaluatedetail
{
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[@"commodityid"] = _FCcommodityid;
    
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQStoreGoodsHasBeenEvaluateCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
        ...
        if([[dic objectForKey:@"success"] isEqualToString:@"true"])
        {
            ...
            FCarraydata = [[dic objectForKey:@"data"] objectForKey:@"evaluatelist"];

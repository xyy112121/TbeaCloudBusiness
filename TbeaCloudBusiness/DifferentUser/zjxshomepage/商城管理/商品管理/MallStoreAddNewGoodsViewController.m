//
//  MallStoreAddNewGoodsViewController.m
//  TbeaCloudBusiness
//
...
#import "MallStoreAddNewGoodsViewController.h"

@interface MallStoreAddNewGoodsViewController ()

@end

@implementation MallStoreAddNewGoodsViewController
    ...
    if(indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            ...
            case 2:
                ...
                textfield.text = FCspecialmodelname;
                [cell.contentView addSubview:textfield];
                break;
            case 3:
                labelname.text = @"商品价格";
            ...
            case 7:
                ...
                {
                    for(int i=0;i<[FCarraythumbimage count];i++)
                    {
                        UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(0+70*i, 10, 60, 60)];
                        imageview.image = [FCarraythumbimage objectAtIndex:i];
                        [FCthumbscrollview addSubview:imageview];
                    }
                }
                break;
    ...
    else if(indexPath.section == 1)
    {
        switch (indexPath.row)
        {
            ...
            case 1:
                ...
                if([FCarraypictureimage count]==0)
                {
                    imageadd = [[UIImageView alloc] initWithFrame:CGRectMake(0, 10, 60, 60)];
                    imageadd.image = LOADIMAGE(@"useraddpic", @"png");
                    imageadd.userInteractionEnabled = YES;
                ...
                {
                    for(int i=0;i<[FCarraypictureimage count];i++)
                    {
                        UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(0+70*i, 10, 60, 60)];
                        imageview.image = [FCarraypictureimage objectAtIndex:i];
                        [FCdetailscrollview addSubview:imageview];
                    }
                }
                break;
...
{
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[@"commodityid"] = FCCommodityId;
    params[@"name"] = FCName;

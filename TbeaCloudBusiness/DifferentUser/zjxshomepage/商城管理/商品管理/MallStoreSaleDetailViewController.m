//
//  MallStoreSaleDetailViewController.m
//  TbeaCloudBusiness
//
...
#import "MallStoreSaleDetailViewController.h"

@interface MallStoreSaleDetailViewController ()

@end

@implementation MallStoreSaleDetailViewController
...
-(void)initheaderview:(NSDictionary *)sender Frame:(CGRect)frame
{
    ...
    UILabel *labelpingjia = [[UILabel alloc] initWithFrame:CGRectMake(XYViewL(labeltitle),XYViewTop(lablemoneyvalue)-20,230,20)];
...
-(void)clickgoodsedit:(id)sender
{
    ...
    goodsdetail.FCCommodityId = _FCcommodityid;
...
-(void)getgoodssaledetail
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQStoreGoodsSaleDetailInfoCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{

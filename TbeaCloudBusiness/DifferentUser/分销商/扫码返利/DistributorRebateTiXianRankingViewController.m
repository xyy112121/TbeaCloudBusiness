//
//  DistributorRebateTiXianRankingViewController.m
//  TbeaCloudBusiness
//
...
#import "DistributorRebateTiXianRankingViewController.h"

@interface DistributorRebateTiXianRankingViewController ()

@end

@implementation DistributorRebateTiXianRankingViewController
...
//    [buttonright addTarget:self action: @selector(clicktimeselect:) forControlEvents: UIControlEventTouchUpInside];
...
-(UIView *)viewselectitem:(CGRect)frame
{
    ...
    buttonitemarea.backgroundColor = [UIColor clearColor];
...
-(void)clicktimeselect:(id)sender
{
...
-(void)getrebatesortlist:(NSString *)page Pagesize:(NSString *)pagesize
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:REDistributorTiXianRankingCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{

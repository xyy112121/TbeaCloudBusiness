//
//  DistributorRebateHpViewController.m
//  TbeaCloudBusiness
//
...
#import "DistributorRebateHpViewController.h"

@interface DistributorRebateHpViewController ()

@end

@implementation DistributorRebateHpViewController
...
- (void)viewDidLoad {
    ...
    [buttonright addTarget:self action: @selector(gotoqrcode:) forControlEvents: UIControlEventTouchUpInside];
...
-(UIView *)cashdataview
{
    ...
    lableispayvalue.text = [NSString stringWithFormat:@"%@",[FCdictakemoney objectForKey:@"totlepayedforthismonth"]];
    ...
    lablenopayvalue.text =  [NSString stringWithFormat:@"%@",[FCdictakemoney objectForKey:@"totleincomeforthismonth"]];;
...
{
    DistributorRebateTiXianHistoryViewController *tixiandata = [[DistributorRebateTiXianHistoryViewController alloc] init];
...
{
    DistributorRebateTiXianRankingViewController *sortmore = [[DistributorRebateTiXianRankingViewController alloc] init];
...
-(void)getscanrebatelist
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:REDistributorScanRebateHpCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
        
    } Success:^(NSDictionary *dic) {
        DLog(@"dic====%@",dic);
        if([[dic objectForKey:@"success"] isEqualToString:@"true"])
        {
            FCdictakemoney = [[dic objectForKey:@"data"] objectForKey:@"payandincomestaticinfo"];

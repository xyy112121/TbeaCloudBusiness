//
//  DistributorRebateTiXianRankingViewController.h
//  TbeaCloudBusiness
//
...
@interface DistributorRebateTiXianRankingViewController : UIViewController<AndyDropDownDelegate,ActionDelegate,UITableViewDelegate,UITableViewDataSource>
{

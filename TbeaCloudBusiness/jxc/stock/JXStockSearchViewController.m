...
#import "YTextField.h"
@interface JXStockSearchViewController ()

@end

@implementation JXStockSearchViewController
...
{
	YTextField *textfield = (YTextField *)[self.view viewWithTag:101];
	if([textfield.text length]==0)
	{
        [MBProgressHUD showError:@"请输入查询内容！" toView:self.view];

	}
	else
	{
		if([delegate1 respondsToSelector:@selector(jxsearchstock:)])
		{
			[delegate1 jxsearchstock:textfield.text];
			[self returnback:nil];
		}
	}
}
